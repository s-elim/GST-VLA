...
# === Hybrid-VLA Pretraining Configs ===

@dataclass
class Exp_Hybrid_OXE_Magic_Soup_Plus_Minus(Exp_SigLIP_224px_Bridge):
...
class VLARegistry(Enum):
    ...
    # === Hybrid-VLA Pretraining Configs ===
    EXP_HYBRID_OXE_MAGIC_SOUP_PLUS_MINUS = Exp_Hybrid_OXE_Magic_Soup_Plus_Minus
